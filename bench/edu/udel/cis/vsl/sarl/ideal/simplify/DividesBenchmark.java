...
public class DividesBenchmark {
	...
	xyy, divPoly, onePxPxSqdP3x4th, mixedXYTermPoly, bigMixedXYTermPoly, xSqrLess1, xSqrP1;
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < size; i++){
			//divPoly = divPoly * (x + c)
			divPoly = preUniv.multiply(divPoly, preUniv.add(xInt, cInt));
			out.println(divPoly);
		}
