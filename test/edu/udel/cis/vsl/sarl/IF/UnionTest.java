...
public class UnionTest {
	...
	public void setUp() throws Exception {
		...
		union1 = universe.unionType(
				...
				universe.typeSequence(new SymbolicType[] { intType, realType,
	...
	public void injectExtract1() {
		SymbolicExpression ten = universe.symbolic(10);
	...
	public void arrayOfUnion() {
		...
		assertEquals(
				...
				universe.unionExtract(universe.intObject(1),
						universe.arrayRead(a, universe.symbolic(0))));
		assertEquals(
				universe.symbolic(true),
				universe.unionExtract(universe.intObject(2),
						universe.arrayRead(a, universe.symbolic(1))));
		assertEquals(
				universe.symbolic(10),
				universe.unionExtract(universe.intObject(0),
						universe.arrayRead(a, universe.symbolic(2))));
	}
	...
	public void unionTestTest() {
		...
		assertEquals(universe.symbolic(true), test0);
		assertEquals(universe.symbolic(false), test1);
		assertEquals(universe.symbolic(false), test2);
	}
}
