...
/**
 * 
 * @author rwjones Test class for collections.common.PcollectionsSymbolicSet
 */
public class PcollectionsSymbolicSetTest {
	...
	private static PcollectionsHashSet<SymbolicExpression> pSetHash;
	private static PcollectionsHashSet<SymbolicExpression> pSetHash2;
	private static PcollectionsHashSet<SymbolicExpression> pSetHash3;
	private static PcollectionsHashSet<SymbolicExpression> pSetCollection;
	private static PcollectionsHashSet<SymbolicExpression> pSetCollection2;
	private static PcollectionsHashSet<SymbolicExpression> pSetCollection3;
	...
	private PcollectionsHashSet<SymbolicExpression> canonicSet;
	private PcollectionsHashSet<SymbolicExpression> canonicSet2;
	private PcollectionsHashSet<SymbolicExpression> canonicSet3;
	...
	public static String iteratorString(
			PcollectionsHashSet<SymbolicExpression> T) {
	...
	public void setUp() throws Exception {
		...
		pSetHash = new PcollectionsHashSet<SymbolicExpression>(pTree);
		pSetHash = (PcollectionsHashSet<SymbolicExpression>) pSetHash
				.add(five);
		pSetHash = (PcollectionsHashSet<SymbolicExpression>) pSetHash
				.add(three);
		pSetHash = (PcollectionsHashSet<SymbolicExpression>) pSetHash
				.add(otherfive);
		pSetHash2 = new PcollectionsHashSet<SymbolicExpression>(pTree);
		pSetHash2 = (PcollectionsHashSet<SymbolicExpression>) pSetHash2
				.add(five);
		pSetHash2 = (PcollectionsHashSet<SymbolicExpression>) pSetHash2
				.add(three);
		pSetHash2 = (PcollectionsHashSet<SymbolicExpression>) pSetHash2
				.add(otherfive);
		pSetHash3 = new PcollectionsHashSet<SymbolicExpression>(pTree);

		pSetCollection = new PcollectionsHashSet<SymbolicExpression>(
				collectionSet);
		pSetCollection = (PcollectionsHashSet<SymbolicExpression>) pSetCollection
				.add(five);
		pSetCollection = (PcollectionsHashSet<SymbolicExpression>) pSetCollection
				.add(three);
		pSetCollection = (PcollectionsHashSet<SymbolicExpression>) pSetCollection
				.add(otherfive);
		pSetCollection2 = new PcollectionsHashSet<SymbolicExpression>(
				collectionSet);
		pSetCollection2 = (PcollectionsHashSet<SymbolicExpression>) pSetCollection2
				.add(five);
		pSetCollection2 = (PcollectionsHashSet<SymbolicExpression>) pSetCollection2
				.add(three);
		pSetCollection2 = (PcollectionsHashSet<SymbolicExpression>) pSetCollection2
				.add(otherfive);
		pSetCollection3 = new PcollectionsHashSet<SymbolicExpression>(
				collectionSet);

		pSetPlain = new PcollectionsHashSet<SymbolicExpression>();
		pSetPlain = (PcollectionsHashSet<SymbolicExpression>) pSetPlain
				.add(five);
		pSetPlain = (PcollectionsHashSet<SymbolicExpression>) pSetPlain
				.add(three);
		pSetPlain = (PcollectionsHashSet<SymbolicExpression>) pSetPlain
		...
		pSetPlain2 = (PcollectionsHashSet<SymbolicExpression>) pSetPlain2
				.add(five);
		pSetPlain2 = (PcollectionsHashSet<SymbolicExpression>) pSetPlain2
				.add(three);
		pSetPlain2 = (PcollectionsHashSet<SymbolicExpression>) pSetPlain2
		...
		canonicSet = new PcollectionsHashSet<SymbolicExpression>(
				collectionSet);
		canonicSet2 = new PcollectionsHashSet<SymbolicExpression>(
				collectionSet);
		canonicSet3 = new PcollectionsHashSet<SymbolicExpression>(
				collectionSet);

		canonicSet3 = (PcollectionsHashSet<SymbolicExpression>) canonicSet3
				.add(twenty);
		canonicSet3 = (PcollectionsHashSet<SymbolicExpression>) canonicSet3
				.add(hundred);

		canonicSet = (PcollectionsHashSet<SymbolicExpression>) canonicSet
				.add(twenty);
		canonicSet = (PcollectionsHashSet<SymbolicExpression>) canonicSet
				.add(eighty);
		canonicSet = (PcollectionsHashSet<SymbolicExpression>) canonicSet
	...
	public void testToStringBufferLong() {
		assertEquals(pSetHash.toStringBufferLong().toString(),
				"UnsortedSet{3,5}");
		assertEquals(pSetHash3.toStringBufferLong().toString(), "UnsortedSet{}");

		assertEquals(pSetCollection.toStringBufferLong().toString(),
				"UnsortedSet{3,5}");
		assertEquals(pSetCollection3.toStringBufferLong().toString(),
				"UnsortedSet{}");

		assertEquals(pSetPlain.toStringBufferLong().toString(),
				"UnsortedSet{3,5}");
		assertEquals(pSetPlain3.toStringBufferLong().toString(),
				"UnsortedSet{}");
	}
	...
	public void testAddAll() {
		assertEquals(pSetHash.toString(), "{3,5}");
		assertEquals(pSetHash.addAll(pSetHash3.add(ten).add(four).add(nine))
				.toString(), "{3,4,5,9,10}");

		assertEquals(pSetCollection.toString(), "{3,5}");
		assertEquals(
				pSetCollection.addAll(
						pSetCollection3.add(ten).add(four).add(nine))
						.toString(), "{3,4,5,9,10}");

		assertEquals(pSetPlain.toString(), "{3,5}");
		assertEquals(pSetPlain.addAll(pSetPlain3.add(ten).add(four).add(nine))
				.toString(), "{3,4,5,9,10}");
	}
	...
	public void testRemoveAll() {
		assertEquals(pSetHash.addAll(pSetHash3.add(ten).add(four).add(nine))
				.removeAll(pSetHash2).toString(), "{4,9,10}");
		assertEquals(
				pSetCollection
						.addAll(pSetCollection3.add(ten).add(four).add(nine))
						.removeAll(pSetCollection2).toString(), "{4,9,10}");
		assertEquals(pSetPlain.addAll(pSetPlain3.add(ten).add(four).add(nine))
				.removeAll(pSetCollection2).toString(), "{4,9,10}");
