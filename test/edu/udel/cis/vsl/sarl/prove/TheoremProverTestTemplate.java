...
/**
 * A template for testing theorem provers.
 * Instead of directly calling the methods of a specific theorem prover,
 * it is recommended to call the methods of the theorem prover interface.
 * In this way, the tests could be reused later when more theorem provers
 * are introduced.
 * 
 * A list of TheoremProver instances is defined, and 
 * in setUpBeforeClass, you can initialize it with a number of provers.
 * 
 * In checkResult, a predicate is proved by each of the provers in the list,
 * and the counter example will be printed if the result is invalid.
 * 
...
public class TheoremProverTestTemplate {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		System.out.println("Initalizing provers...");
		provers.add(Prove.newCVC3TheoremProverFactory(universe).
				newProver(context));
		System.out.println("Context of new prover: " + context.toString() + "...");
		
		//add more provers (either cvc3 prover or other provers) here
	}
