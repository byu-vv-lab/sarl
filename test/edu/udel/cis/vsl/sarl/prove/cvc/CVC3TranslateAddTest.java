...
public class CVC3TranslateAddTest {
	 ...
	 * expressions and adds them to an SymbolicCollection. The test then
	 * compares the translated symboliccollection list and the validity checker.
	 */
	...
	public void testTranslateAddOneArg() {
		...
		SymbolicCollection<NumericExpression> addList = universe
				.basicCollection(s1);
	...
	/**
	 * testTranslateAddTwoArg compares the validity checker and a
	 * CVC3TheoremProver when taking two numericExpression arguments.
	 */
	...
	/**
	 * testTranslateAddTwoArgSymbolic compares the valditychecker and a
	 * CVC3ThoremProver when taking two symbolic constants.
	 */
