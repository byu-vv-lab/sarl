...
//		Expr x1and2Exist = cvcProver.translate(andExpression);
	...
	{
		// make array
		SymbolicConstant values = universe
				.symbolicConstant(universe.stringObject("values"), intArrayType);
		// fill array
		...
		SymbolicExpression forAll = expressionFactory
				.expression(SymbolicOperator.FORALL, boolType,
						values, valuesPositive);
		Expr translateResult = cvcProver.translate(forAll);
