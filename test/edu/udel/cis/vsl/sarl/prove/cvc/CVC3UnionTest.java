...
public class CVC3UnionTest {
	...
	public void setUp() throws Exception {
		...
		// add true bool
		unionArray = universe.arrayWrite(unionArray, universe.integer(0), // index
																			// of
																			// array
				universe.unionInject(intRealBoolUnion, universe.intObject(2), // 2
																				// is
																				// index
																				// of
																				// type
						...
						booleanExprTrue));
		// add 10.5 real
		unionArray = universe.arrayWrite(unionArray, universe.integer(1), // index
																			// of
																			// array
				universe.unionInject(intRealBoolUnion, universe.intObject(1), // 1
																				// is
																				// index
																				// of
																				// type
						...
						tenAndHalf));
		// add 0 int
		unionArray = universe.arrayWrite(unionArray, universe.integer(2), // index
																			// of
																			// array
				universe.unionInject(intRealBoolUnion, universe.intObject(0), // 0
																				// is
																				// index
																				// of
																				// type
	...
	public void testTranslateUnionInject() {
		// inject bool false
		SymbolicExpression injectBoolFalse = universe.unionInject(
				intRealBoolUnion, universe.intObject(2), booleanExprFalse);

		SymbolicExpression injectBoolFalse2 = expressionFactory.expression(
				SymbolicOperator.UNION_INJECT, intRealBoolUnion,
	...
	public void testTranslateUnionExtract() {
		...
		SymbolicExpression extractReal = universe.unionExtract(
				universe.intObject(1), injectedTenandHalf);

		// this version gives an error on translateUnionExtract (unknown
		// constructor)
		...
		assertEquals(translateResult.getType(),
				cvcProver.translateType(realType));
	}
}
