...
public class LittleCVC4Example4 {
	...
	public static void main(String[] args) {
		...
		terms = new vectorExpr();
		terms.add(em.mkExpr(Kind.MULT, negOne, x)); // -x
		terms.add(three); // 3
		sum = em.mkAssociative(Kind.PLUS, terms); // -x+3
		t1 = em.mkExpr(Kind.EQUAL, zero, sum); // 0=-x+3
		// exists x. 0=-x+3
