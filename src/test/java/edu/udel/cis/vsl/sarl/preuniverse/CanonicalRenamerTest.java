...
public class CanonicalRenamerTest {
	...
	public void canonic1() {
		...
		if (debug) out.println(expression1 + " -> " + expression1_new);
	...
	public void canonic2() {
		...
		if (debug) out.println(X1 + " -> " + X1_new);
