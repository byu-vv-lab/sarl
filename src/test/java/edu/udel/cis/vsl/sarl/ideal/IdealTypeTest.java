...
public class IdealTypeTest {
	...
	public void number(){
		...
		if (debug) out.println("Number=" +ne);
	...
	public void constantCreation() {
		if (debug) out.println("constantCreation: " + intTen);
	...
	public void symbolicConstantCreate() {
		if (debug) out.println("symbolicConstantCreate: " + x);
	...
	public void polynomial() {
		...
		if (debug) out.println("Zero Polynomial=" + b);
