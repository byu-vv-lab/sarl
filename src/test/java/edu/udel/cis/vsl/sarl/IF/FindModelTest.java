...
public class FindModelTest {
	...
	public void findX() {
		...
		if (debug) out.println("findX: X = " + value);
	...
	public void array1() {
		...
		assertTrue(model != null);
		value = model.get(a);
		if (debug) out.println("array1: value = " + value);
		out.flush();
		assertTrue(value != null);
	...
	public void array2() {
		...
		assertTrue(model != null);
		value = model.get(a);
		if (debug) out.println("array2: value = " + value);
		out.flush();
		assertTrue(value != null);
	...
	public void array3() {
		...
		assertTrue(model != null);
		value = model.get(a);
		if (debug) out.println("array3: value = " + value);
		out.flush();
		assertTrue(value != null);
