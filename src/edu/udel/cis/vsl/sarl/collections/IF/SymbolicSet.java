 ...
 * 
 * A set may be sorted or unsorted.  A sorted set uses a Comparator
 * to order the elements of the set from least to greatest.
 * 
 * @author siegel
 * 
 */
public interface SymbolicSet<T extends SymbolicExpression> extends
	...
	/**
	 * Is this a sorted set?
	 * 
	 * @return true iff this set is sorted
	 */
	boolean isSorted();
